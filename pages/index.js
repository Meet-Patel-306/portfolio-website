    ...
    <div className={`relative ${data.showCursor && "cursor-none"}`}>
      ...
      <div className="container mx-auto mb-10">
        ...
        <div className="mt-10 laptop:mt-30 p-2 laptop:p-0" ref={workRef}>
          <h1 className="text-3xl tablet:text-4xl laptop:text-4xl laptopl:text-4xl p-1 tablet:p-2 font-bold w-full laptop:w-4/5">
            Project
          </h1>
        ...
        <div className="mt-10 p-2 laptop:p-0" ref={aboutRef}>
          ...
          <div className="flex flex-col laptop:flex-row tablet:m-10 gap-4 laptop:items-start tablet:items-center">
            {/* Image - shown on top for mobile/tablet, side for laptop */}
            <img
              src="./images/temp-image.png" // replace with your image path
              alt="Your description"
              className="w-[400px] h-[400px] rounded-xl object-cover"
            />

            {/* Paragraph */}
            <p className="mt-2 opacity-50 text-xl laptop:text-3xl w-full laptop:w-3/5">
              {data.aboutpara}
            </p>
          </div>
        </div>
        <div className="mt-10 laptop:mt-30 p-2 laptop:p-0">
          ...
          <div className="flex flex-wrap justify-center">
            <div className="flex items-center border w-fit px-2 py-3 border-zinc-500 rounded-lg text-sm  select-none gap-x-2 m-2">
              <svg
                stroke="currentColor"
                fill="currentColor"
                strokeWidth="0"
